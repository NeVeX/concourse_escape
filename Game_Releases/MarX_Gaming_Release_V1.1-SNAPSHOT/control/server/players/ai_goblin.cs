...
function AIGoblin::onStuck(%this,%obj)
{
...
function AIGoblin::unBlock(%this,%obj)
{
...
function AIGoblin::onReachDestination(%this,%obj)
{
...
function AIGoblin::checkForThreat(%this,%obj)
{
//   echo( "checkForThreat...");
   if(!isObject(%obj))
      return;
...
function AIGoblin::DoScan(%this,%obj)
{
...
function AIGoblin::openFire(%this,%obj)
{
   if(!isObject(%obj))
      return;
...
function AIGoblin::ceaseFire(%this,%obj)
{
...
function AIGoblin::onTargetEnterLOS(%this,%obj)
{
...
function AIGoblin::onTargetExitLOS(%this,%obj)
{
   // If an aim target object is set, this method is invoked when
...
function AIGoblin::setRandomDestination(%this,%obj)
{
   if(!isObject(%obj))
      return;
...
function CreateGoblins()
{
  ...
  for (%i = 1; %i < 10; %i++ ) {
  	schedule(%i * 100, 0, "creating_goblins",%i);
  	echo("hello");
...
function creating_goblins(%i) {
	echo("did i get here");
	AIPlayer::spawnBot(%i,""@(%i+5*-1) @" " @(%i+%i*2) @" " @72 @" " @1 @" " @0 @" " @0 @" " @0);
}

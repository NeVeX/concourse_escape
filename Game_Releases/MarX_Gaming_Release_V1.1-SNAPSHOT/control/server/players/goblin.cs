...
//============================================================================
$Play_Sound = getRandom(3);
// Load dts shapes and merge animations
Exec("~/data/goblin/player.cs");
...
function AIGoblin::onAdd(%this,%obj)
{
   // Vehicle timeout
...
function AIGoblin::onRemove(%this, %obj)
{
   if (%obj.client.player == %obj)
      %obj.client.player = 0;
}

function AIGoblin::onNewDataBlock(%this,%obj)
{
}
...
function AIGoblin::onMount(%this,%obj,%vehicle,%node)
{
   if (%node == 0)  {
...
function AIGoblin::onUnmount( %this, %obj, %vehicle, %node )
{
   if (%node == 0)
      %obj.mountImage(%obj.lastWeapon, $WeaponSlot);
}

function AIGoblin::doDismount(%this, %obj, %forced)
{
...
function AIGoblin::onCollision(%this,%obj,%col)
{
...
function AIGoblin::onImpact(%this, %obj, %collidedObject, %vec, %vecLen)
{
...
function AIGoblin::damage(%this, %obj, %sourceObject, %position, %damage, %damageType)
{
   if (%obj.getState() $= "Dead")
      return;
...
function AIGoblin::onDamage(%this, %obj, %delta)
{
...
function AIGoblin::onDisabled(%this,%obj,%state)
{
...
function AIGoblin::onLeaveMissionArea(%this, %obj)
{
   // Inform the client
//   %obj.client.onLeaveMissionArea();
}

function AIGoblin::onEnterMissionArea(%this, %obj)
{
   // Inform the client
...
function AIGoblin::onTrigger(%this, %obj, %triggerNum, %val)
{
